...
level_endless::level_endless(sf::Vector2u window_size, sf::Sprite rock_sprite, train* tTrain)
{
...
void level_endless::step(sf::Time elapsed, sf::Time time_overall, sf::RenderWindow &window_l)
{
    //////////////////////////////////////////////////////////////// PORUSZANIE
    ...
    if(rock_fill_cooldown <= 0)
    {
        ...
        std::string random_line = RandomLine();
